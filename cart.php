						...
						<td class="align-middle">
							<div class="input-group quantity mx-auto" style="width: 100px">
								<div class="input-group-btn">
									<button class="btn btn-sm btn-black btn-minus">
										<i class="fa fa-minus"></i>
									</button>
								</div>
								<input type="text" class="form-control form-control-sm bg-white border-0 text-center" value="1" />
								<div class="input-group-btn">
									<button class="btn btn-sm btn-black btn-plus">
		...
		<div class="col-lg-4">
			...
			<div class="bg-white p-30 mb-5">
				...
				<div class="pt-2">
					...
					<a href="checkout-en.php" class="btn btn-block btn-black font-weight-bold my-3 py-3 text-decoration-none">Proceed To Checkout</a>
				</div>
			</div>
		</div>
	</div>
