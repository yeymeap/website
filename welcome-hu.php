...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-center">
        <a class="mb-5 me-3 btn btn-black text-decoration-none" href="index-hu.php">Kattints ide ha nem történne semmi</a>
        <a class="mb-5 mx-3 btn btn-danger text-decoration-none" href="logout-hu.php">Kijelentkezés</a>
