		...
		<div class="col-lg-9 col-md-8 mb-5">
			...
			<div class="row pb-3">
				...
				<div class="col-lg-4 col-md-6 col-sm-6 pb-1">
					<div class="product-item bg-light mb-4">
						<div class="product-img position-relative overflow-hidden">
							<a href="product.php?id=1"><img class="img-fluid w-100" src="img/guitar-1.png" alt="" /></a>
						</div>
						<div class="text-center py-4">
							<a class="h6 text-decoration-none text-truncate text-black" href="product.php?id=1">Fender Squier Affinity Series</a>
							<div class="d-flex align-items-center justify-content-center mt-2">
								<h5>218€</h5>
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6 pb-1">
					<div class="product-item bg-light mb-4">
						<div class="product-img position-relative overflow-hidden">
							<a href="product.php?id=2"><img class="img-fluid w-100" src="img/guitar-2.png" alt="" /></a>
						</div>
						<div class="text-center py-4">
				...
				<div class="col-lg-4 col-md-6 col-sm-6 pb-1">
					<div class="product-item bg-light mb-4">
						<div class="product-img position-relative overflow-hidden">
							<a href="product.php?id=3"><img class="img-fluid w-100" src="img/guitar-3.png" alt="" /></a>
						</div>
						<div class="text-center py-4">
							<a class="h6 text-decoration-none text-truncate text-black" href="product.php?id=3">Fender Squier 40th Anniversary</a>
							<div class="d-flex align-items-center justify-content-center mt-2">
								<h5>499€</h5>
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6 pb-1">
					<div class="product-item bg-light mb-4">
						<div class="product-img position-relative overflow-hidden">
							<a href="product.php?id=4"><img class="img-fluid w-100" src="img/guitar-4.png" alt="" /></a>
						</div>
						<div class="text-center py-4">
							<a class="h6 text-decoration-none text-truncate text-black" href="product.php?id=4">Fender Player Series</a>
							<div class="d-flex align-items-center justify-content-center mt-2">
								<h5>933€</h5>
							</div>
						</div>
