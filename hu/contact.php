	...
	<div class="row px-xl-5">
		<div class="col-12">
			<nav class="breadcrumb bg-white mb-30">
				...
				<span class="breadcrumb-item active">Kapcsolatfelvéltel</span>
			</nav>
		</div>
	</div>
</div>
...
<div class="container-fluid">
	<h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
		<span class="bg-white pe-3">Lépj Velünk Kapcsolatba</span>
	</h2>
	<div class="row px-xl-5">
		<div class="col-lg-12 mb-5">
			...
			<div class="bg-light p-30 mb-3">
				<p class="mb-2 d-flex justify-content-center">
					<i class="fa fa-map-marker-alt text-black me-3 pe-1"></i>Školská 938/6, Dunajská Streda, 929 01, Slovakia
				</p>
				<p class="mb-2 d-flex justify-content-center">
