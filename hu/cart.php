...
<div class="container fluid">
	...
	<form action="cart.php" method="post">
		<div class="col-lg-12 d-flex justify-content-center">
			<table class="mx-5 table table-white table-borderless text-center mb-5">
				...
				<tbody>
					<?php if (empty($products)) : ?>
						<tr>
							<td colspan="5" style="text-align:center; padding-left:150px">Nincs termék a kosárban</td>
						</tr>
					<?php else : ?>
							...
							<tr>
								<div>
									...
									<td>
										...
										<br>
										<a href="cart.php?remove=<?= $product['id'] ?>" class="remove">Eltávolítás</a>
									</td>
								</div>
			...
			<div class="mx-2">
				<h3 class="text-black">Végösszeg</h3>
		...
		<div class="d-flex justify-content-center">
			<div>
				<input class='btn btn-black my-2' type="submit" value="Frissítés" name="update">
				<a href="checkout.php"><input class='btn btn-black' type="submit" value="Rendelés" name="checkout"></a>
			</div>
		</div>
	</form>
</div>
