...
<div class="container fluid">
	...
	<form action="cart.php" method="post">
		<div class="col-lg-12 d-flex justify-content-center">
			<table class="mx-5 table table-white table-borderless text-center mb-5">
				...
				<tbody>
					<?php if (empty($products)) : ?>
						<tr>
							<td colspan="5" style="text-align:center">Nincs termék a kosárban</td>
						</tr>
					<?php else : ?>
			...
			<div class="my-2 mx-2">
				<span class="text-black">Végösszeg</span>
				<i class="text-black d-flex justify-content-center" style="margin-top: 30px;"><?= $subtotal ?>&euro;</i>
			</div>
		</div>
		<div class="d-flex justify-content-center">
			<div class="">
				<input class='btn btn-black my-2' type="submit" value="Frissités" name="update">
				<a href="placeorder.php"><input class='btn btn-black' type="submit" value="Rendelés leadása" name="placeorder"></a>
			</div>
		</div>
	</form>
</div>
