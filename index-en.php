							...
							<div
								...
								<div
									...
									<div class="p-3" style="max-width: 700px">
										...
										<a
											class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp text-decoration-none"
											href="guitars-en.html"
											>Shop Now</a
										>
									</div>
								</div>
			...
			<div class="row px-xl-5 pb-3">
				<div class="col-lg-3 col-md-4 col-sm-6 pb-1">
					<a
						...
						href="guitars-en.html#acousticg">
				...
				<div class="col-lg-3 col-md-4 col-sm-6 pb-1">
					<a
						class="text-decoration-none"
						href="guitars-en.html#electricg">
						<div
		...
		<div class="container-fluid pt-5">
			...
			<div class="row px-xl-5 pb-3">
				<div class="col-lg-3 col-md-4 col-sm-6 pb-1">
					<a
						class="text-decoration-none"
						href="amplifiers-en.html#electron">
						<div
							class="cat-item img-zoom d-flex align-items-center mb-4">
							<div
								class="overflow-hidden"
				...
				<div class="col-lg-3 col-md-4 col-sm-6 pb-1">
					<a
						class="text-decoration-none"
						href="amplifiers-en.html#transistor">
						<div
							class="cat-item img-zoom d-flex align-items-center mb-4">
							<div
								class="overflow-hidden"
				...
				<div class="col-lg-3 col-md-4 col-sm-6 pb-1">
					<a
						class="text-decoration-none"
						href="amplifiers-en.html#modelling">
						<div
							class="cat-item img-zoom d-flex align-items-center mb-4">
							<div
								class="overflow-hidden"
